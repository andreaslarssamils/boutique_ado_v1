...
ACCOUNT_AUTHENTICATION_METHOD = (
    "username_email"  # Users can log in with either their username or email
)
ACCOUNT_EMAIL_REQUIRED = True  # Email is required for registration
ACCOUNT_EMAIL_VERIFICATION = "mandatory"  # Users must verify their email address
ACCOUNT_SIGNUP_EMAIL_ENTER_TWICE = (
    True  # Users must enter their email address twice during signup
)
ACCOUNT_USERNAME_MIN_LENGTH = 4  # Minimum length for usernames
LOGIN_URL = "/accounts/login/"  # URL to redirect users to for login
LOGIN_REDIRECT_URL = "/"  # URL to redirect users to after login
